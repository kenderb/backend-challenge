...
module Orders
  # Persists an Order and a corresponding OutboxEvent in a single database transaction,
  # ensuring atomicity between business state and event storage (transactional outbox).
  # Event delivery is handled by Outbox::Relay; this service does not publish to RabbitMQ.
  class CreateWithOutbox
    ...
    def call
      ...
      validate_customer!
      Success.new(value: create_order_and_outbox_event)
